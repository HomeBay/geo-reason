...
let getPoints = ({geometry}) =>
	Option.fold([], GeoJSON_Geometry.getPoints, geometry);

let getLines = ({geometry}) =>
	Option.fold([], GeoJSON_Geometry.getLines, geometry);

let getPolygons = ({geometry}) =>
	Option.fold([], GeoJSON_Geometry.getPolygons, geometry);
